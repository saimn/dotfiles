...
#
# Source: https://gist.github.com/Pezmc/38017cb03daccb17d3835280c568dc0f
#
...
# Image Magick policy issue: https://stackoverflow.com/a/57721936
sudo mv /etc/ImageMagick-7/policy.{xml,off}
...
sudo mv /etc/ImageMagick-7/policy.{off,xml}

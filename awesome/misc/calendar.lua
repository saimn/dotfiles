...
--[[
      ...
      * (c) 2013, Luke Bonham  
      -- needs Tamsyn font for ideal display                   
...
function calendar:attach(widget, args)
    local args = args or {}
    calendar.icons = args.icons or awful.util.getdir("config").."/misc/cal/white/"
    calendar.font_size = tonumber(args.font_size) or 10.5
    ...
    widget:add_signal("mouse::enter", function () calendar:show() end)
    widget:add_signal("mouse::leave", function () calendar:hide() end)

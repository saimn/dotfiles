...
(defun color-theme-wombat ()
  "Color theme 'wombat', by Lars Nielsen, Emacsified by Peter Severin and Scott Jaderholm + http://dengmao.wordpress.com/2007/01/22/vim-color-scheme-wombat/#comment-1051, created 2009-06-23."
  (interactive)
  (color-theme-install
   '(color-theme-wombat
     ...
     (anything-header ((t (:foreground "Blue" :background "grey20" :box (:line-width -1 :style released-button)))))
     ...
     (ediff-even-diff-Ancestor ((t (:background "Grey" :foreground "Blue"))))
     (ediff-even-diff-B ((t (:background "Grey" :foreground "Blue"))))
     ...
     (ediff-odd-diff-C ((t (:background "Grey" :foreground "Blue"))))
     (egg-an-tag-mono ((t (:bold t :weight bold :foreground "LightGreen"))))
     (egg-blame ((t (:background "grey15" :foreground "Blue"))))
     (egg-blame-culprit ((t (:family "Sans Serif" :background "grey15" :foreground "grey60" :height 1.1))))
     (egg-blame-subject ((t (:background "grey15" :family "Sans Serif" :foreground "Blue" :height 1.1))))
     ...
     (header-line ((t (:box (:line-width -1 :style released-button) :background "grey20" :foreground "blue" :box nil))))
     ...
     (menu ((t (:foreground "#f6f3e8" :background "#242424"))))
     ...
     (org-agenda-date ((t (:foreground "LightSteelBlue"))))
     ...
     (org-level-1 ((t (:foreground "#e5786d"))))
     ...
     (org-level-6 ((t (:foreground "#cae682"))))
     ...
     (scroll-bar ((t (:foreground "#f6f3e8"))))
     ...
     (tool-bar ((t (:background "#f6f3e8" :foreground "#242424" :box (:line-width 1 :style released-button)))))
     (tooltip ((t (:family "Sans Serif" :background "#444444" :foreground "#8ac6f2"))))

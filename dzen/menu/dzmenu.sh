...
echo "${dzen_iconpath}/xbm8x8/fox.xbm"
IC1=${dzen_iconpath}/../xbm8x8/fox.xbm
IC2=${dzen_iconpath}/../xbm8x8/gimp.xbm
IC3=${dzen_iconpath}/../xbm8x8/note.xbm
IC4=${dzen_iconpath}/../xbm8x8/leaf.xbm
IC5=${dzen_iconpath}/../xbm8x8/pcman.xbm
SMI=${dzen_iconpath}/../xbm8x8/arrow.xbm
...
| (dzen2 -y "$YP" -x "$XP" -fn "$barXFont" -bg "$BG1" -fg "$FG1" -l 7 -tw 125 -ta l -w 125 -m -p -e 'onstart=uncollapse;button1=menuexec;leaveslave=exit;button3=exit')